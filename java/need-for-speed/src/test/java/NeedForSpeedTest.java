...
public class NeedForSpeedTest {
    ...
    @Tag ("task:3")
    @DisplayName (
        "The distanceDriven method returns the correct distance after driving multiple times")
    ...
    @Tag ("task:4")
    @DisplayName (
        "The batteryDrained method returns false when car battery did not completely drain after " +
            "driving")
    ...
    @Tag ("task:4")
    @DisplayName (
        "The batteryDrained method returns true when battery completely drained after driving")
    ...
    @Tag ("task:5")
    @DisplayName (
        "The distanceDriven method returns the correct distance after driving a nitro car")
    ...
    @Tag ("task:5")
    @DisplayName (
        "The batteryDrained method returns false when nitro battery did not completely drain " +
            "after driving")
    ...
    @Tag ("task:5")
    @DisplayName (
        "The batteryDrained method returns true when nitro battery completely drained after " +
            "driving")
