...
public class GigasecondTest {
    ...
    public void modernTime () {
        ...
        assertThat(gigaSecond.getDateTime()).isEqualTo(
            LocalDateTime.of(2043, Month.JANUARY, 1, 1, 46, 40));
    }
    ...
    public void afterEpochTime () {
        ...
        assertThat(gigaSecond.getDateTime()).isEqualTo(
            LocalDateTime.of(2009, Month.FEBRUARY, 19, 1, 46, 40));
    }
    ...
    public void withFullTimeSpecified () {
        ...
        assertThat(gigaSecond.getDateTime()).isEqualTo(
            LocalDateTime.of(2046, Month.OCTOBER, 2, 23, 46, 40));
    }
    ...
    public void withFullTimeSpecifiedAndDayRollover () {
        ...
        assertThat(gigaSecond.getDateTime()).isEqualTo(
            LocalDateTime.of(2046, Month.OCTOBER, 3, 1, 46, 39));
    }
