...
public class AppointmentSchedulerTest {
    ...
    public void testHasPassedOneYearAgo () {
        var oneYearAgo = LocalDateTime.now()
            .minusYears(1)
            .plusHours(2);
    ...
    public void testHasPassedMonthsAgo () {
        var monthsAgo = LocalDateTime.now()
            .minusMonths(8);
    ...
    public void testHasPassedHoursAgo () {
        var hoursAgo = LocalDateTime.now()
            .minusHours(12);
    ...
    public void testHasPassedMinutesAgo () {
        var minutesAgo = LocalDateTime.now()
            .minusMinutes(55);
    ...
    public void testHasPassedOneMinuteAgo () {
        var oneMinuteAgo = LocalDateTime.now()
            .minusMinutes(1);
    ...
    public void testHasPassedHoursFromNow () {
        var hoursFromNow = LocalDateTime.now()
            .plusHours(3);
    ...
    public void testHasPassedDaysFromNow () {
        var daysFromNow = LocalDateTime.now()
            .plusDays(19);
    ...
    public void testHasPassedMonthsFromNow () {
        var monthsFromNow = LocalDateTime.now()
            .plusMonths(10);
    ...
    public void testHasPassedYearsFromNow () {
        var yearsFromNow = LocalDateTime.now()
            .plusYears(2)
            .plusMonths(3)
            .plusDays(6);
    ...
    public void testAnniversaryDate () {
        var expected = LocalDate.of(LocalDate.now()
            .getYear(), Month.SEPTEMBER, 15);
