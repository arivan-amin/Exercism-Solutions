...
public class BirdWatcherTest {
    ...
    public void itTestGetLastWeek () {
        assertThat(birdWatcher.getLastWeek()).containsExactly(DAY1, DAY2, DAY3, DAY4, DAY5, DAY6,
            TODAY);
    }
    ...
    @Tag ("task:5")
    @DisplayName (
        "The getCountForFirstDays method returns overall count when number of days is higher than" +
            " array size")
    public void itTestGetCountForMoreDaysThanTheArraySize () {
        assertThat(birdWatcher.getCountForFirstDays(10)).isEqualTo(
