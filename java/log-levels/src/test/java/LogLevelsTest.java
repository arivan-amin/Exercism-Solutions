...
public class LogLevelsTest {
    ...
    @Tag ("task:1")
    @DisplayName (
        "The message method returns the log line's message after removing leading and trailing " +
            "spaces")
    ...
    public void error_reformat () {
        assertThat(LogLevels.reformat("[ERROR]: Segmentation fault")).isEqualTo(
    ...
    public void warning_reformat () {
        assertThat(LogLevels.reformat("[WARNING]: Decreased performance")).isEqualTo(
    ...
    public void info_reformat () {
        assertThat(LogLevels.reformat("[INFO]: Disk defragmented")).isEqualTo(
