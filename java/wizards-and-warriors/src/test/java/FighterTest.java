...
class FighterTest {
    ...
    void testWarriorOverridesToStringMethod () {
        assertThat(warrior.hasMethod("toString")).withFailMessage("Method toString must be created")
            .isTrue();
        assertThat(warrior.isMethodPublic("toString")).withFailMessage(
                "Method toString must be public")
            .isTrue();
        assertThat(warrior.isMethodReturnType(String.class, "toString")).withFailMessage(
                "Method toString must return a String")
            .isTrue();
    }
    ...
    @Tag ("task:2")
    @DisplayName (
        "The toString method of the Warrior returns the correct description of the fighter")
    ...
    void testWarriorOverridesIsVulnerableMethod () {
        assertThat(warrior.hasMethod("isVulnerable")).withFailMessage(
                "Method isVulnerable must be created")
            .isTrue();
        assertThat(warrior.isMethodReturnType(boolean.class, "isVulnerable")).withFailMessage(
                "Method isVulnerable must return a boolean")
            .isTrue();
    }
    ...
    void testWarriorOverridesGetDamagePointsMethod () {
        assertThat(warrior.hasMethod("getDamagePoints", Fighter.class)).withFailMessage(
                "Method getDamagePoints(Fighter) must be created")
            .isTrue();
        assertThat(warrior.isMethodReturnType(int.class, "getDamagePoints",
            Fighter.class)).withFailMessage("Method getDamagePoints(Fighter) must return an int")
            .isTrue();
    }
    ...
    void testWizardOverridesToStringMethod () {
        assertThat(wizard.hasMethod("toString")).withFailMessage("Method toString must be created")
            .isTrue();
        assertThat(warrior.isMethodPublic("toString")).withFailMessage(
                "Method toString must be public")
            .isTrue();
        assertThat(wizard.isMethodReturnType(String.class, "toString")).withFailMessage(
                "Method toString must return a String")
            .isTrue();
    }
    ...
    @Tag ("task:6")
    @DisplayName (
        "The toString method of the Wizard returns the correct description of the fighter")
    ...
    void testWizardHasPrepareSpellMethod () {
        assertThat(wizard.hasMethod("prepareSpell")).withFailMessage(
                "Method prepareSpell must be created")
            .isTrue();
    }
    ...
    void testFighterDoesNotHavePrepareSpellMethod () {
        assertThatExceptionOfType(NoSuchMethodException.class).isThrownBy(
            () -> Fighter.class.getDeclaredMethod("prepareSpell"));
    }
    ...
    void testWizardOverridesIsVulnerableMethod () {
        assertThat(wizard.hasMethod("isVulnerable")).withFailMessage(
                "Method isVulnerable must be created")
            .isTrue();
        assertThat(wizard.isMethodReturnType(boolean.class, "isVulnerable")).withFailMessage(
                "Method isVulnerable must return a boolean")
            .isTrue();
    }
    ...
    void testWizardOverridesGetDamagePointsMethod () {
        assertThat(wizard.hasMethod("getDamagePoints", Fighter.class)).withFailMessage(
                "Method getDamagePoints(Fighter) must be created")
            .isTrue();
        assertThat(
            wizard.isMethodReturnType(int.class, "getDamagePoints", Fighter.class)).withFailMessage(
                "Method getDamagePoints(Fighter) must return an int")
            .isTrue();
    }
