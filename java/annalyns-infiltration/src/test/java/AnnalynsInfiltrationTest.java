...
public class AnnalynsInfiltrationTest {
    ...
    public void cannot_spy_if_everyone_is_sleeping () {
        ...
        assertThat(
            AnnalynsInfiltration.canSpy(knightIsAwake, archerIsAwake, prisonerIsAwake)).isFalse();
    }
    ...
    public void can_spy_if_everyone_but_knight_is_sleeping () {
        ...
        boolean prisonerIsAwake = false;
        assertThat(
            AnnalynsInfiltration.canSpy(knightIsAwake, archerIsAwake, prisonerIsAwake)).isTrue();
    }
    ...
    public void cannot_signal_prisoner_if_archer_is_awake_and_prisoner_is_sleeping () {
        ...
        boolean prisonerIsAwake = false;
        assertThat(
            AnnalynsInfiltration.canSignalPrisoner(archerIsAwake, prisonerIsAwake)).isFalse();
    }
    ...
    public void cannot_release_prisoner_if_everyone_is_awake_and_pet_dog_is_present () {
        ...
        assertThat(
            AnnalynsInfiltration.canFreePrisoner(knightIsAwake, archerIsAwake, prisonerIsAwake,
                petDogIsPresent)).isFalse();
    }
    ...
    @Tag ("task:4")
    @DisplayName (
        "The canFreePrisoner method returns true when only prisoner is awake and pet dog is " +
            "present")
    ...
    @Tag ("task:4")
    @DisplayName (
        "The canFreePrisoner method returns false when only knight is sleeping and pet dog is " +
            "present")
    ...
    @Tag ("task:4")
    @DisplayName (
        "The canFreePrisoner method returns true when only archer is sleeping and pet dog is " +
            "present")
    ...
    @Tag ("task:4")
    @DisplayName (
        "The canFreePrisoner method returns false when only archer is sleeping and pet dog is " +
            "absent")
    ...
    @Tag ("task:4")
    @DisplayName (
        "The canFreePrisoner method returns false when only prisoner is sleeping and pet dog is " +
            "present")
