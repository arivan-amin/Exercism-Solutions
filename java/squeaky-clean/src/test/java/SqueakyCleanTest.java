...
public class SqueakyCleanTest {
    ...
    @Tag ("task:2")
    @DisplayName (
        "The clean method returns a string in camel case after removing a dash and replaces a " +
            "whitespace")
    ...
    @Tag ("task:2")
    @DisplayName (
        "The clean method returns a string in camel case and replaces leading and trailing " +
            "whitespaces")
