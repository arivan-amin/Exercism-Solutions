...
public class BlackjackTest {
    ...
    @Tag ("task:3")
    @DisplayName (
        "The firstTurn method returns strategy Automatically Win given ten-ace and dealer five")
    ...
    @Tag ("task:3")
    @DisplayName (
        "The firstTurn method returns strategy Automatically Win given king-ace and dealer nine")
