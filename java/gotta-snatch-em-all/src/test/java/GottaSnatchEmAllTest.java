...
class GottaSnatchEmAllTest {
    ...
    @Tag ("task:1")
    @DisplayName (
        "newCollection returns a set with one card when given a list with one repeated card")
    ...
    @Tag ("task:1")
    @DisplayName (
        "newCollection returns a set with two cards when given a list with two unique cards")
    ...
    @Tag ("task:2")
    @DisplayName (
        "addCard doesn't add the card to the collection when it already contains the new card")
    ...
    @Tag ("task:3")
    @DisplayName (
        "canTrade returns true when both collections have at least one card the other doesn't have")
    ...
    @Tag ("task:3")
    @DisplayName (
        "canTrade returns false when my collection is a non-empty subset of their collection")
    ...
    @Tag ("task:3")
    @DisplayName (
        "canTrade returns false when their collection is a non-empty subset of my collection")
    ...
    void testCommonCardsAllCardsDifferent () {
        List<Set<String>> collections =
            List.of(Set.of("Veevee"), Set.of("Bleakachu"), Set.of("Wigglycream"));
    ...
    void testAllCardsMultipleCollections () {
        List<Set<String>> collections = List.of(Set.of("Veevee", "Wigglycream", "Mayofried"),
            ...
            Set.of("Cooltentbro", "Mayofried", "Wigglycream"));
        Set<String> expected =
            Set.of("Cooltentbro", "Gyros", "Mayofried", "Shazam", "Veevee", "Wigglycream");
        assertThat(GottaSnatchEmAll.allCards(collections)).isEqualTo(expected);
    }
}
