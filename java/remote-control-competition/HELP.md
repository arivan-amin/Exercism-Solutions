...
`exercism submit src/main/java/ExperimentalRemoteControlCar.java src/main/java/ProductionRemoteControlCar.java src/main/java/RemoteControlCar.java src/main/java/TestTrack.java`
command.
