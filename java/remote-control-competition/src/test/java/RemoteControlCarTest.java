...
public class RemoteControlCarTest {
    ...
    @Tag ("task:1")
    @DisplayName (
        "The ExperimentalRemoteControlCar is an instance of the RemoteControlCar interface")
    ...
    @Tag ("task:2")
    @DisplayName (
        "The getDistanceTravelled method of the ProductionRemoteControlCar returns 10 after " +
            "driving once")
    ...
    @Tag ("task:2")
    @DisplayName (
        "The getDistanceTravelled method of the ExperimentalRemoteControlCar returns 20 after " +
            "driving once")
    ...
    public void race () {
        ...
        TestTrack.race(experimentalCar);
        assertThat(experimentalCar.getDistanceTravelled() -
            productionCar.getDistanceTravelled()).isEqualTo(20);
    }
    ...
    public void rankTwoCars () {
        ...
        assertThat(rankings.get(0)
            .getNumberOfVictories()).isEqualTo(3);
        assertThat(rankings.get(1)
            .getNumberOfVictories()).isEqualTo(2);
    }
    ...
    public void rankManyCars () {
        ...
        List<ProductionRemoteControlCar> rankings = TestTrack.getRankedCars(unsortedCars);
        assertThat(rankings.get(0)
            .getNumberOfVictories()).isEqualTo(7);
        assertThat(rankings.get(1)
            .getNumberOfVictories()).isEqualTo(5);
        assertThat(rankings.get(2)
            .getNumberOfVictories()).isEqualTo(3);
        assertThat(rankings.get(3)
            .getNumberOfVictories()).isEqualTo(2);
        assertThat(rankings.get(4)
            .getNumberOfVictories()).isEqualTo(1);
        assertThat(rankings.get(5)
            .getNumberOfVictories()).isEqualTo(0);
    }
}
